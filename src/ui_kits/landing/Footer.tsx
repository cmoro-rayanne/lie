    ...
    >
      <div style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: '0 var(--gutter)' }}>
        <div style={{ textAlign: 'center', marginBottom: 'clamp(56px,7vw,90px)' }}>
          ...
          >
            “Mais do que seguir uma metodologia, meu compromisso é acompanhar você em seu processo
            singular de crescimento, realização e expansão da própria vida.”
          </p>
        </div>
        ...
        >
          <div>
            ...
            >
              Acompanhando pessoas em processos de autoconhecimento, desenvolvimento emocional e
                ...
                <li key={l.href}>
                  <a
                    ...
                    onMouseEnter={(e: React.MouseEvent<HTMLAnchorElement>) =>
                      (e.currentTarget.style.color = 'rgba(192,169,130,0.9)')
                    }
                    onMouseLeave={(e: React.MouseEvent<HTMLAnchorElement>) =>
                      (e.currentTarget.style.color = 'rgba(220,205,185,0.65)')
                    }
                  >
                    {l.label}
                  </a>
        ...
        >
          ...
          >
            Feito com{' '}
            <span style={{ color: 'rgba(192,130,100,0.65)', display: 'inline-flex' }}>
              <Heart size={11} />
            </span>{' '}
            e cuidado por{' '}
            <a
